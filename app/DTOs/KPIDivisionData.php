...
readonly class KPIDivisionData
{
    public function __construct(
        public int $year,
        public int $company_policy_detail_id,
        public int $division_id,
        public string $division_goals,
        public ?string $target_division,
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            year: (int) $data['year'],
            company_policy_detail_id: (int) $data['company_policy_detail_id'],
            division_id: (int) $data['division_id'],
            division_goals: (string) $data['division_goals'],
            target_division: $data['target_division'] ?? null,
