...
class AuthorizationTransactionController extends Controller
{
    public function index()
    {
        $employees = Employee::orderBy('first_name')->get();
        return view('pages.transactionAuthorizer.index', compact('employees'));
    }

    public function data()
    {
        try {
            $query = TransactionAuthorizer::with('employee');
    ...
    {
        return TransactionAuthorizer::findOrFail($id);
    }
    ...
    {
        TransactionAuthorizer::findOrFail($id)->delete();
