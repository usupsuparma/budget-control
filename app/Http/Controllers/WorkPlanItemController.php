    ...
    public function store(Request $request, $id)
    {
        try {
            $validated = $request->validate([
                ...
                'activity_jan' => 'nullable|integer|in:0,1',
                'activity_feb' => 'nullable|integer|in:0,1',
                'activity_mar' => 'nullable|integer|in:0,1',
                'activity_apr' => 'nullable|integer|in:0,1',
                'activity_may' => 'nullable|integer|in:0,1',
                'activity_jun' => 'nullable|integer|in:0,1',
                'activity_jul' => 'nullable|integer|in:0,1',
                'activity_aug' => 'nullable|integer|in:0,1',
                'activity_sep' => 'nullable|integer|in:0,1',
                'activity_oct' => 'nullable|integer|in:0,1',
                'activity_nov' => 'nullable|integer|in:0,1',
                'activity_dec' => 'nullable|integer|in:0,1',
