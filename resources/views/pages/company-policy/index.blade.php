...
<style>
    ...
    #companyPolicyTable tbody td {
        padding: 6px 8px;
        /* default Bootstrap ~12px */
        vertical-align: middle;
        line-height: 1.2;
    }

    #companyPolicyTable thead th {
        padding: 8px;
        vertical-align: middle;
    }

    /* Kecilkan button di kolom Aksi */
    #companyPolicyTable .btn {
        padding: 4px 6px;
        font-size: 12px;
        line-height: 1;
    }
    ...
    /* Kecilkan icon */
    #companyPolicyTable .btn i {
        font-size: 14px;
    }

    /* Link PDF agar tidak nambah tinggi row */
    #companyPolicyTable .btn-link {
        padding: 0;
        font-size: 13px;
    }
</style>
            ...
            <div class="card">
                <div class="card-header d-flex">
                    ...
                    <div class="col-md-4 col-xl-6 col-xxl-8 text-end">
                        <button type="button" class="btn btn-workplan btn-sm" data-bs-toggle="modal"
