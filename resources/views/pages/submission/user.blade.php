...
<script>
    ...
    function updateAllBudgetSelects() {
        ...
        availableBudgetItems.forEach(function(item) {
            options +=
                `<option value="${item.id}" data-value="${item.total}" data-code="${item.budget_code}">${item.label}</option>`;
        });
                                                                ...
                                                                availableBudgetItems
                                                                    .forEach(
                                                                        function(
                                                                            ...
                                                                            budgetOptions
                                                                                +=
                                                                                `<option value="${item.id}" data-value="${item.total}" data-code="${item.budget_code}" ${selected}>${item.label}</option>`;
                                                                        });
